...
public class GetHelp extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (gpsTracker.canGetLocation())
        {
            ...
            messend="Patient is injured at "+addressLine+","+city+","+postalCode;
            ...
            for(int i=0;i<medlatlon.length;i++)
            {
                ...
                if((medlatlon[i][0]>(x-50)) && (medlatlon[i][0]<(x+50)))
                {
                    ...
                    {   final LatLng medicalcentre = new LatLng(medlatlon[i][0] ,medlatlon[i][1]);
                        Toast.makeText(getApplicationContext(), "Medical centre found",Toast.LENGTH_LONG).show();
